  ...
  return (
    <div className="border-b border-gray-200 p-2">
      <button
        ...
        className={`w-full flex justify-between items-center px-4 py-2 hover:bg-cyan-50 focus:outline-none font-semibold ${
          isOpen ? 'bg-cyan-50 text-[#22b8cf]' : 'bg-white hover:bg-cyan-50 text-[#495057]'
        }`}
      >
